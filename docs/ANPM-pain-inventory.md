...
| N-004 | **Fody / Cecil / post-build** меняют assembly после compile → snupkg checksum mismatch | ci | [SO#62630172](https://stackoverflow.com/questions/62630172), Cecil#610 | Док: не pack после IL-weave без rebuild; symbol health в L3 | open |
