...
$sln = if (Test-Path (Join-Path $PlatformRoot 'AIGuiders.Platform.slnx')) {
    Join-Path $PlatformRoot 'AIGuiders.Platform.slnx'
} else {
    Join-Path $PlatformRoot 'AIGuiders.Platform.sln'
}
